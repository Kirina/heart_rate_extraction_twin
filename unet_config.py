...
#                     "cropped_twin_ECG_dataset" : "cropped_twin_ECG",
                    ...
                    "length_data": 147443, 
                    "data_points_train" : 30, #change this to use more of the training data                   
                    "data_points_test" : 10,
                    "missing_patients" : [63, 485], 
                    "exclude_patients" : [18, 103, 141, 151, 382], # Recording too short
                    "source_names" : ["heart_ecg"],
...
#                     "num_layers": 12,
                    "kernel_size": 15,
                    "num_channels": 4, #input and output channels model
                    "num_channels_output": 8, #input and output channels model
...
#                     "output_type" : "difference", # Type of output layer, either "direct" or "difference". Direct output: Each source is result of tanh activation and independent. DIfference: Last source output is equal to mixture input - sum(all other sources)
                    "output_path":"C:/Users/kirin/Documents/Internship/output",
                    "data_storage_path": "C:/Users/kirin/Documents/Internship/data/",
                    "output_type": "direct",
